...
public class Phone
{
    ...
    [XmlElement(ElementName = "landline")] public string? Landline { get; set; }
}
...
public class Family
{
    ...
    [XmlElement(ElementName = "born")] public string? Born { get; set; }

    [XmlElement(ElementName = "address")] public Address? Address { get; set; }

    [XmlElement(ElementName = "phone")] public Phone? Phone { get; set; }
}
...
public class Person
{
    ...
    [XmlElement(ElementName = "family")] public List<Family> Family { get; set; }
}

[XmlRoot(ElementName = "people")]
public class People
{
    [XmlElement(ElementName = "person")] public List<Person>? Person { get; set; }
}